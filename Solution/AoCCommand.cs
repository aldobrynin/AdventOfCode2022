...
public class AoCCommand : Command<AoCCommand.AoCCommandSettings>
{
    ...
    {
        AnsiConsole.MarkupLine(":christmas_tree::christmas_tree::christmas_tree:Day [underline red]{0}[/] of AoC 2022:christmas_tree::christmas_tree::christmas_tree:", dayType.Day);
...
#pragma warning restore CS8765
    {
        ...
        {
            Measure.Time(() => RunSolution(tuple, settings.Sample))
                .Dump("Finished in ");
        }
